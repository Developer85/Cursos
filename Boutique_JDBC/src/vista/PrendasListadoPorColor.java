 ...
 * @author usuari
 */
public class PrendasListadoPorColor extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form GUI_LlistatPerColor
     */
    public PrendasListadoPorColor(String color) {
        prendas = prendasFuente.selectPrendasPorColor(color);
        initComponents();
        this.setTitle("Listado por Color (" + color + ")");
